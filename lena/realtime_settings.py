...
def build_turn_detection() -> TurnDetection:
    ...
    """
    td_type = _get_env_str("LENA_TURN_DETECTION_TYPE", "server_vad")
    eagerness = _get_env_str("LENA_TURN_EAGERNESS", "medium")

    return TurnDetection(
        type=td_type,  # "server_vad" or "semantic_vad"
        threshold=_get_env_float("LENA_TURN_THRESHOLD", 0.5),
        prefix_padding_ms=_get_env_int("LENA_TURN_PREFIX_PADDING_MS", 160),
        silence_duration_ms=_get_env_int("LENA_TURN_SILENCE_DURATION_MS", 520),
